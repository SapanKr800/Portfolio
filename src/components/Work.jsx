            ...
            <Wrapper >
                ...
                <div className=" bg-white py-20 px-6 md:px-16" id='mywork'>
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        ...
                        <h2 className="text-3xl font-light text-gray-900 mb-8">My latest work</h2>
                    ...
                    <div className="flex justify-center">
                        ...
                        <button className="flex justify-center cursor-pointer items-center gap-3 right-0 md:px-6 px-4 py-2 bg-white border rounded-full hover:bg-gray-800 hover:text-white transition duration-300 text-[clamp(0.8rem,2vw,1rem)]">
                            Show more
